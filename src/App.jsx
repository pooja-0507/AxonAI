    ...
    <>
      <div className="w-screen min-h-screen overflow-x-hidden bg-[#0E0E0E] text-white">
          ...
          isResponseScreen ?
            ...
            <div className="middle h-[80vh] flex items-center flex-col justify-center">
              ...
              <div className="boxes mt-[30px] flex items-center gap-2">
                ...
                <div className="card rounded-lg cursor-pointer transition-all hover:bg-[#201f1f] px-[20px] relative min-h-[20vh] bg-[#181818] p-[10px]">
                  <p className='text-[18px]'>Which is the smallest<br />
                    planet of our solar system? <br />
                   </p>
        ...
        <div className="bottom w-[100%] flex flex-col items-center">
          ...
          <p className='text-[gray] text-[16px] my-2'>AxonAI is developed by Pooja lalwani. This AI use the gemini API for giving the responses.</p>
          <p className='text-[gray]'> Copyright © 2025 Pooja Lalwani.</p>
